...
<h2 class="text-center mt-5 text-green">Edenio c’est la solution pour une alimentation saine,  des économies et pour préserver l’environnement.</h2>
<div class="flex justify-center">
  <img src="../public/imageindex5.webp" alt="" class="h-10 w-10 mt-10">
</div>
<p class="text-center mt-5 ml-5 m-auto">Des produits bio, local et de qualité pour préservez notre environnement</p>

<div class="flex justify-center">
  <img src="../public/imageindex6.webp" alt="" class="h-10 w-10 mt-10">
</div>
<p class="text-center mt-5">Moins de transport pour plus d’économie et un meilleur respect de l’environnement</p>


<div class="flex justify-center">
  <img src="../public/imageindex7.webp" alt="" class="h-10 w-10 mt-10">
</div>
<p class="text-center mt-5">Des produits locaux, pour un meilleur gout dans l’assiette</p>
